package hotelshare.repository;

import hotelshare.HotelshareApp;
import hotelshare.config.Constants;
import hotelshare.config.audit.AuditEventConverter;
import hotelshare.domain.PersistentAuditEvent;
...
import static hotelshare.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
